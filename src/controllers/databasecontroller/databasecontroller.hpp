...
public:
    ...
    std::optional<uint64_t> findIfUserID(const std::string& username, const std::string& tablename); // check if user found and return 0 if not found or return ID if found
